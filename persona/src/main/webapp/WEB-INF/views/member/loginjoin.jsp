        ...
        <div class="loginjoin">
            <div class="user singinBx">
                ...
                <div class="formBx">
                    ...
                    <h2>소셜로그인</h2>
                    <ul class="sci">
                        <li><a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=나의API&redirect_uri=http://localhost:8082/member/kalogin"><img alt="" src="/imgs/kakaoIcon.png"></a></li>
                    </ul>
                </div>
            </div>
